...
export function Events() {
    ...
    return (
        <div className="max-w-[1400px] mx-auto min-h-screen pb-20 px-4 md:px-6 space-y-8 animate-in fade-in duration-500">
            ...
            {/* Header Area */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-6 sticky top-0 z-30 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-4 -mx-4 px-4 md:mx-0 md:px-0 md:static">
                <div>
