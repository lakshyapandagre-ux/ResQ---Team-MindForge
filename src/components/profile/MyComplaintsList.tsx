...
export function MyComplaintsList({ userId }: { userId: string }) {
    ...
    if (complaints.length === 0) return <div className="text-center p-8 text-slate-500">You haven't posted any complaints yet.</div>;
